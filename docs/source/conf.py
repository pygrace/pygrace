# -*- coding: utf-8 -*-
#
# pygrace documentation build configuration file, created by
...
try:
    os.symlink(scripts+os.sep+'pygrace_cdf', scripts+os.sep+'_pygrace_cdf.py')
except:
    pass
...
modindex_common_prefix = ['pygrace.']#,'pygrace.extensions.','pygrace.interactive.','pygrace.styles.','pygrace.tests.']
